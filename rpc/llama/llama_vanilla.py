        ...
        **kwargs,
        ...
        if "heatmap" in self.config.mode:
            ...
            if q_len == 1:
                ...
                zeros = torch.zeros(q_len, 1696-1-kv_len, device=attn_weights.device, dtype=attn_weights.dtype)
                ...
                zeros = torch.zeros(q_len, 1696-1-q_len, device=attn_weights.device, dtype=attn_weights.dtype)
