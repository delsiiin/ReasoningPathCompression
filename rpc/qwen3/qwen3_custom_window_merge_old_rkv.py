...
from transformers.models.qwen3_moe.modeling_qwen3_moe import load_balancing_loss_func, Qwen3MoeRMSNorm
...
def Qwen3_Ours_init(self, config: Qwen3MoeConfig, layer_idx: int):
...
def Qwen3_Ours_CausalLM_forward(
    self,
