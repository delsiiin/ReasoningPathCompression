...
data = {
    "AIME24": {
        ...
        "QwQ-32B": {
            ...
            "ThinKV":       [7.2, 27.2, 48.5, 59.4, 79.5, 79.5],
        },
        "Qwen3-30B": {
            "full_cache": 97.2,
            "R-KV":         [6.3, 57.3, 70.8, 80.8, 97.2, 97.2],
            "T2O":         [8.5, 61.7, 75.5, 82.7, 97.2, 97.2],
            "ThinKV":       [7.4, 59.5, 69.2, 84.5, 97.2, 97.2],
        },
    },
    "LiveCodeBench": {
        "R1-Qwen-7B": {
            ...
            "ThinKV":       [1.1, 15.7, 27.2, 37.2, 37.6, 37.6],
        },
        "R1-Qwen-14B": {
            "full_cache": 53.1,
        ...
        "R1-Qwen-32B": {
            ...
            "ThinKV":       [1.9, 21.1, 25.5, 39.8, 57.2, 57.2],
        },
        "R1-Llama-8B": {
            "full_cache": 32.14,
        ...
        "QwQ-32B": {
            ...
            "ThinKV":       [5.5, 27.5, 28.5, 44.2, 61.6, 62.7],
        },
        "Qwen3-30B": {
            "full_cache": 66.0,
    ...
    "MATH-500": {
        ...
        "QwQ-32B": {
            ...
            "ThinKV":       [41.1, 71.9, 86.5, 98.0, 99.8],
        },
        "Qwen3-30B": {
            "full_cache": 97.2,
    ...
    "GPQA": {
        "R1-Qwen-7B": {
            ...
            "ThinKV":       [13.0, 24.1, 23.2, 37.5, 48.8, 49.1],
        },
        "R1-Qwen-14B": {
            "full_cache": 59.1,
        ...
        "R1-Qwen-32B": {
            ...
            "ThinKV":       [22.1, 32.4, 38.5, 56.2, 62.1, 62.1],
        },
        "R1-Llama-8B": {
            "full_cache": 49.0,
        ...
        "QwQ-32B": {
            ...
            "ThinKV":       [24.6, 39.1, 53.5, 62.5, 65.3, 65.6],
        },
        "Qwen3-30B": {
            "full_cache": 73.4,
            "R-KV":         [22.4, 37.8, 51.3, 66.8, 72.2, 73.4],
            "T2O":         [25.8, 42.1, 54.7, 68.2, 73.1, 73.4],
            "ThinKV":       [24.1, 40.0, 49.8, 69.5, 73.4, 73.4],
        },
    },
}
