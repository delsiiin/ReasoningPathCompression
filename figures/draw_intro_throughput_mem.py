...
generation_lengths_llama = ["1k", "2k", "4k", "8k", "16k", "32k"]
generation_lengths_qwq = ["1k", "2k", "4k", "8k", "16k"]
...
ax1.set_title('R1-Llama-8B (Layer 18)', fontsize=22)
ax1.set_xlabel('Key Position', fontsize=20)
ax1.set_ylabel('Query Position', fontsize=20)
...
ax2.set_title('QwQ-32B (Layer 42)', fontsize=22)
ax2.set_xlabel('Key Position', fontsize=20)
ax2.set_ylabel('Query Position', fontsize=20)
...
ax3.text(x_positions_llama[-1], 100, "OOM", ha='center', va='center', fontsize=20, color='black')

# Labeling for third subplot
ax3.set_title('R1-Llama-8B (Batch Size 16)', fontsize=22)
ax3.set_xlabel('Generation Length', fontsize=20)
ax3.set_ylabel('Peak Memory (GB)', fontsize=20)
ax3.set_xticks(x_positions_llama)
ax3.set_xticklabels(generation_lengths_llama, fontsize=16)
...
ax3_twin.set_ylabel('Throughput (Tokens/s)', fontsize=20)
ax3_twin.tick_params(axis='y', labelsize=16)
...
ax4.text(x_positions_qwq[-1], 100, "OOM", ha='center', va='center', fontsize=20, color='black')

# Labeling for fourth subplot
ax4.set_title('QwQ-32B (Batch Size 8)', fontsize=22)
ax4.set_xlabel('Generation Length', fontsize=20)
ax4.set_ylabel('Peak Memory (GB)', fontsize=20)
ax4.set_xticks(x_positions_qwq)
ax4.set_xticklabels(generation_lengths_qwq, fontsize=16)
...
ax4_twin.set_ylabel('Throughput (Tokens/s)', fontsize=20)
ax4_twin.tick_params(axis='y', labelsize=16)
